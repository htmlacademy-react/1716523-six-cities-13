...
export const offers: OffersType = [
  ...
  // },
  // {
  //   'id': 'd11f9f55-080e-467c-aaf9-660726f41791',
  //   'title': 'Tile House',
  //   'type': 'hotel',
  //   'price': 125,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': '4609d7ec-7673-4da3-98ce-4640bdb781bf',
  //   'title': 'Penthouse, 4-5 rooms + 5 balconies',
  //   'type': 'hotel',
  //   'price': 210,
  ...
  // },
  // {
  //   'id': 'c81d3df9-81f1-4d29-b5dd-4072243eacda',
  //   'title': 'Perfectly located Castro',
  //   'type': 'apartment',
  //   'price': 230,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/5.jpg',
  ...
  // },
  // {
  //   'id': '77ed2bdd-091d-477c-aef3-ed5ba2e1ce4d',
  //   'title': 'Nice, cozy, warm big bed apartment',
  //   'type': 'room',
  //   'price': 251,
  ...
  // },
  // {
  //   'id': '239180e2-a5c9-4b6b-9733-5f4a777130a9',
  ...
  // },
  // {
  //   'id': 'd3d53df1-ba33-47ba-aa41-72ae1c012e73',
  //   'title': 'The Joshua Tree House',
  //   'type': 'apartment',
  //   'price': 423,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/10.jpg',
  ...
  // },
  // {
  //   'id': '22a74426-5891-4537-b376-e7353ff1c122',
  //   'title': 'Wood and stone place',
  //   'type': 'hotel',
  //   'price': 460,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/9.jpg',
  ...
  // },
  // {
  //   'id': '291f810c-d8f0-453c-8c14-bbea6161859f',
  //   'title': 'Penthouse, 4-5 rooms + 5 balconies',
  //   'type': 'house',
  //   'price': 512,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/3.jpg',
  ...
  // },
  // {
  //   'id': '572b1f65-e496-4c50-84f0-0c1de6f850b5',
  //   'title': 'Waterfront with extraordinary view',
  //   'type': 'apartment',
  //   'price': 237,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/10.jpg',
  ...
  // },
  // {
  //   'id': '1e6daa88-1364-44d6-84c1-54a2004ea461',
  //   'title': 'Tile House',
  //   'type': 'apartment',
  //   'price': 217,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/20.jpg',
  ...
  // },
  // {
  //   'id': 'fb537761-0ac8-44fd-a039-3a4a9a60dc73',
  //   'title': 'Perfectly located Castro',
  //   'type': 'house',
  //   'price': 401,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/18.jpg',
  ...
  // },
  // {
  //   'id': 'b1e0eb52-4c07-4578-8a65-a5f0f7b4d14d',
  //   'title': 'The Pondhouse - A Magical Place',
  //   'type': 'hotel',
  //   'price': 440,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/15.jpg',
  ...
  // },
  // {
  //   'id': '18b37bec-8f8e-4e24-9315-3d19de2e7851',
  //   'title': 'Amazing and Extremely Central Flat',
  //   'type': 'house',
  //   'price': 337,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/8.jpg',
  ...
  // },
  // {
  //   'id': 'bd9c9d42-c928-4f99-9e28-f8d84c11b19e',
  //   'title': 'Tile House',
  //   'type': 'room',
  //   'price': 284,
  ...
  // },
  // {
  //   'id': '3bde5372-7730-41e6-b893-9cfb32676577',
  //   'title': 'Penthouse, 4-5 rooms + 5 balconies',
  //   'type': 'hotel',
  //   'price': 156,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': '429af9a2-2cc5-40be-b63f-e02e182be523',
  //   'title': 'Wood and stone place',
  //   'type': 'house',
  //   'price': 717,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/3.jpg',
  ...
  // },
  // {
  //   'id': '4f592c35-fefa-4d86-ac73-fc9fae8c7fd8',
  //   'title': 'House in countryside',
  //   'type': 'apartment',
  //   'price': 263,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/12.jpg',
  ...
  // },
  // {
  //   'id': '90ea1a88-ad8f-4b43-9759-5aa1359fd3c2',
  //   'title': 'Waterfront with extraordinary view',
  //   'type': 'apartment',
  //   'price': 275,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/16.jpg',
  ...
  // },
  // {
  //   'id': '1e5c2f6e-6710-4b16-9fc8-951db7e60042',
  //   'title': 'The Joshua Tree House',
  //   'type': 'room',
  //   'price': 103,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/20.jpg',
  ...
  // },
  // {
  //   'id': '97644600-4ff4-420b-9c31-23a1afbbc622',
  //   'title': 'Wood and stone place',
  //   'type': 'apartment',
  //   'price': 377,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/8.jpg',
  ...
  // },
  // {
  //   'id': '389327b4-8fbd-4806-8aca-0259e421344c',
  //   'title': 'Tile House',
  //   'type': 'hotel',
  //   'price': 308,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/11.jpg',
  ...
  // },
  // {
  //   'id': 'dc503ef1-ac33-4b83-929e-9b3fb96a1925',
  //   'title': 'Nice, cozy, warm big bed apartment',
  //   'type': 'house',
  //   'price': 616,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/18.jpg',
  ...
  // },
  // {
  //   'id': '6653a75d-9032-4542-88bc-096cd0886b9c',
  //   'title': 'Tile House',
  //   'type': 'apartment',
  //   'price': 265,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/15.jpg',
  ...
  // },
  // {
  //   'id': '36727b70-9fce-4d5e-9646-74256a359be7',
  //   'title': 'Wood and stone place',
  //   'type': 'room',
  //   'price': 144,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/5.jpg',
  ...
  // },
  // {
  //   'id': 'c9c01e1c-5049-4bc6-b7f7-9330a70799c6',
  //   'title': 'The Pondhouse - A Magical Place',
  //   'type': 'apartment',
  //   'price': 353,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/17.jpg',
  ...
  // },
  // {
  //   'id': '879138f6-aaed-435b-a7d5-2520f8ecc530',
  //   'title': 'Waterfront with extraordinary view',
  //   'type': 'room',
  //   'price': 253,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/3.jpg',
  ...
  // },
  // {
  //   'id': 'b75312ff-c025-437f-9ffc-f434417c6938',
  ...
  // },
  // {
  //   'id': 'be1a47b6-5256-424c-833d-2acd6b447464',
  //   'title': 'The Pondhouse - A Magical Place',
  //   'type': 'house',
  //   'price': 115,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/5.jpg',
  ...
  // },
  // {
  //   'id': 'eb303aa6-c214-4c98-a555-95e736993ac3',
  //   'title': 'House in countryside',
  //   'type': 'hotel',
  //   'price': 116,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/17.jpg',
  ...
  // },
  // {
  //   'id': '067a18a9-4538-4fcb-acb8-812a89bac93c',
  //   'title': 'Waterfront with extraordinary view',
  //   'type': 'room',
  //   'price': 186,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/13.jpg',
  ...
  // },
  // {
  //   'id': 'a15426d6-c686-41ce-82c1-1ee085776e09',
  //   'title': 'Penthouse, 4-5 rooms + 5 balconies',
  //   'type': 'room',
  //   'price': 111,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/15.jpg',
  ...
  // },
  // {
  //   'id': '620a0f5a-d881-4e8c-a4eb-322556d6928a',
  //   'title': 'Loft Studio in the Central Area',
  //   'type': 'apartment',
  //   'price': 186,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/11.jpg',
  ...
  // },
  // {
  //   'id': '49c8cb4f-1dc1-45a4-a62c-8d62d07dc756',
  ...
  // },
  // {
  //   'id': '5f533dfb-558c-4c47-9635-be316aa58cc9',
  //   'title': 'Amazing and Extremely Central Flat',
  //   'type': 'hotel',
  //   'price': 421,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': '35ea287a-a1f5-48f0-a15b-baa8890e42e2',
  //   'title': 'Penthouse, 4-5 rooms + 5 balconies',
  //   'type': 'hotel',
  //   'price': 418,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/9.jpg',
  ...
  // },
  // {
  //   'id': '8bdbce1e-1f9a-47d9-841f-023828159234',
  //   'title': 'Tile House',
  //   'type': 'room',
  //   'price': 244,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': 'b4202549-96e6-4287-9b37-c2c0724ed50d',
  //   'title': 'House in countryside',
  //   'type': 'hotel',
  //   'price': 118,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/5.jpg',
  ...
  // },
  // {
  //   'id': '1d33089c-8d72-4052-a8ce-e1c587b09f3f',
  //   'title': 'House in countryside',
  //   'type': 'hotel',
  //   'price': 468,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/7.jpg',
  ...
  // },
  // {
  //   'id': '5cb742ed-d225-4e41-bd00-43be52bc3bb9',
  //   'title': 'Loft Studio in the Central Area',
  //   'type': 'house',
  //   'price': 774,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/7.jpg',
  ...
  // },
  // {
  //   'id': 'dae7e37a-fcc1-4741-8e61-be2b109bffce',
  //   'title': 'Penthouse, 4-5 rooms + 5 balconies',
  //   'type': 'hotel',
  //   'price': 354,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/19.jpg',
  ...
  // },
  // {
  //   'id': 'f4d27558-8608-46c5-9040-112b91fc6e39',
  //   'title': 'Waterfront with extraordinary view',
  //   'type': 'apartment',
  //   'price': 194,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/11.jpg',
  ...
  // },
  // {
  //   'id': 'f4596376-d270-4533-b39b-ac72d0e4311d',
  //   'title': 'Beautiful & luxurious apartment at great location',
  //   'type': 'apartment',
  //   'price': 430,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/16.jpg',
  ...
  // },
  // {
  //   'id': 'e4922818-dfa5-4fa4-ab15-6553b680a0a8',
  //   'title': 'The Joshua Tree House',
  //   'type': 'house',
  //   'price': 489,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/19.jpg',
  ...
  // },
  // {
  //   'id': 'a20fc7f7-e047-401b-8241-9691e902fc8a',
  //   'title': 'Canal View Prinsengracht',
  //   'type': 'room',
  //   'price': 188,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': '15bd5da0-a288-48de-a697-c9d3693a686b',
  //   'title': 'The Pondhouse - A Magical Place',
  //   'type': 'house',
  //   'price': 679,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/11.jpg',
  ...
  // },
  // {
  //   'id': '419b14b8-4004-4b1d-8adb-267a3505e634',
  //   'title': 'The house among olive ',
  //   'type': 'room',
  //   'price': 286,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/15.jpg',
  ...
  // },
  // {
  //   'id': 'afd9fd82-1748-4d22-a07b-6cd1b204a411',
  //   'title': 'Perfectly located Castro',
  //   'type': 'house',
  //   'price': 283,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/4.jpg',
  ...
  // },
  // {
  //   'id': 'bce11811-1e04-4985-b212-888ab4008843',
  //   'title': 'House in countryside',
  //   'type': 'room',
  //   'price': 260,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/12.jpg',
  ...
  // },
  // {
  //   'id': 'a87a8a35-b9a4-4575-a1b5-0c1efa1eda4b',
  //   'title': 'The Pondhouse - A Magical Place',
  //   'type': 'house',
  //   'price': 879,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/6.jpg',
  ...
  // },
  // {
  //   'id': '650969e3-44f5-4dae-9407-707e9e191978',
  //   'title': 'Wood and stone place',
  //   'type': 'house',
  //   'price': 669,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/12.jpg',
  ...
  // },
  // {
  //   'id': 'c76e5f17-3974-4503-87fd-8a07898c2e13',
  //   'title': 'The Joshua Tree House',
  //   'type': 'room',
  //   'price': 216,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/20.jpg',
  ...
  // },
  // {
  //   'id': '93564b9c-4cee-4dbf-a959-c16506aa177b',
  //   'title': 'Wood and stone place',
  //   'type': 'hotel',
  //   'price': 436,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/13.jpg',
  ...
  // },
  // {
  //   'id': '56ddff6e-5158-42fa-80f4-2fe7269a8ca0',
  //   'title': 'House in countryside',
  //   'type': 'house',
  //   'price': 840,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/11.jpg',
  ...
  // },
  // {
  //   'id': '47185513-1afe-4410-bba3-0082f71288e3',
  //   'title': 'The Joshua Tree House',
  //   'type': 'hotel',
  //   'price': 359,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/17.jpg',
  ...
  // },
  // {
  //   'id': '2daa073c-618d-4be5-9886-6f5a66a54360',
  //   'title': 'Tile House',
  //   'type': 'room',
  //   'price': 250,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/1.jpg',
  ...
  // },
  // {
  //   'id': 'a0ca443e-d41d-4f0d-bca8-00ead6e283d0',
  //   'title': 'Loft Studio in the Central Area',
  //   'type': 'apartment',
  //   'price': 133,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/6.jpg',
  ...
  // },
  // {
  //   'id': '5c93fcb6-e627-44b2-b75d-9977db6d27c2',
  //   'title': 'House in countryside',
  //   'type': 'hotel',
  //   'price': 248,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/7.jpg',
  ...
  // },
  // {
  //   'id': 'a8328c1b-1211-4a86-9fdc-70afe7d7990f',
  //   'title': 'House in countryside',
  //   'type': 'room',
  //   'price': 186,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/3.jpg',
  ...
  // },
  // {
  //   'id': 'ee3a64f5-3a9f-4ac3-b379-956441cdd265',
  //   'title': 'The Joshua Tree House',
  //   'type': 'room',
  //   'price': 131,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': '5e43d799-12f0-4cbd-a985-c9c0bda637f1',
  //   'title': 'Perfectly located Castro',
  //   'type': 'apartment',
  //   'price': 353,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/12.jpg',
  ...
  // },
  // {
  //   'id': 'cd31b495-5240-456b-ab5b-0c38383fc838',
  //   'title': 'Beautiful & luxurious apartment at great location',
  //   'type': 'room',
  //   'price': 164,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/4.jpg',
  ...
  // },
  // {
  //   'id': '60c62ffd-b929-4c88-acde-5d501c108993',
  //   'title': 'The Pondhouse - A Magical Place',
  //   'type': 'hotel',
  //   'price': 287,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/19.jpg',
  ...
  // },
  // {
  //   'id': 'c3538f44-4d1e-4152-8cd8-9cd08908c3d6',
  //   'title': 'Beautiful & luxurious apartment at great location',
  //   'type': 'house',
  //   'price': 946,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/16.jpg',
  ...
  // },
  // {
  //   'id': 'f3b6077d-77cc-4a7e-8cf6-f1c34d70460c',
  //   'title': 'Amazing and Extremely Central Flat',
  //   'type': 'hotel',
  //   'price': 220,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/2.jpg',
  ...
  // },
  // {
  //   'id': 'f4aa90be-11e8-48bd-a145-dec5729f52cb',
  //   'title': 'The Joshua Tree House',
  //   'type': 'apartment',
  //   'price': 200,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/7.jpg',
  ...
  // },
  // {
  //   'id': 'de65d369-7628-4249-ac67-c0a49a617cd7',
  //   'title': 'Canal View Prinsengracht',
  //   'type': 'hotel',
  //   'price': 400,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/19.jpg',
  ...
  // },
  // {
  //   'id': 'c4dea8c4-8594-455e-88f0-6ec080a0a014',
  //   'title': 'Tile House',
  //   'type': 'apartment',
  //   'price': 260,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/14.jpg',
  ...
  // },
  // {
  //   'id': '8cee7484-f45a-4770-87c5-9c8f76d73ce9',
  //   'title': 'Waterfront with extraordinary view',
  //   'type': 'apartment',
  //   'price': 292,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/18.jpg',
  ...
  // },
  // {
  //   'id': 'fb0432d2-bf6e-4a03-89c0-1b7da71be581',
  //   'title': 'Wood and stone place',
  //   'type': 'house',
  //   'price': 480,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/19.jpg',
  ...
  // },
  // {
  //   'id': '7ae44cdf-67c3-46a1-af89-295a43a73e42',
  //   'title': 'Amazing and Extremely Central Flat',
  //   'type': 'hotel',
  //   'price': 134,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/14.jpg',
  ...
  // },
  // {
  //   'id': '8b7282a5-9be4-47e4-a246-583a0f9a7dd5',
  //   'title': 'Wood and stone place',
  //   'type': 'hotel',
  //   'price': 482,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/6.jpg',
  ...
  // },
  // {
  //   'id': 'ea99ede1-ee31-4906-b80d-668c31437af4',
  //   'title': 'House in countryside',
  //   'type': 'room',
  //   'price': 144,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/13.jpg',
  ...
  // },
  // {
  //   'id': '91b4c782-4f69-4bf4-acb2-84b945421a85',
  //   'title': 'The Joshua Tree House',
  //   'type': 'hotel',
  //   'price': 205,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/3.jpg',
  ...
  // },
  // {
  //   'id': 'affd2466-3b4a-4eb1-9380-6f9c8a4fdced',
  //   'title': 'Perfectly located Castro',
  //   'type': 'house',
  //   'price': 505,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/5.jpg',
  ...
  // },
  // {
  //   'id': 'bd3768ab-aecb-4c43-9c9d-c8dae2651805',
  //   'title': 'Amazing and Extremely Central Flat',
  //   'type': 'room',
  //   'price': 190,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/14.jpg',
  ...
  // },
  // {
  //   'id': 'a0711744-6143-402d-9e26-0aee692d3952',
  //   'title': 'Amazing and Extremely Central Flat',
  //   'type': 'house',
  //   'price': 727,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/10.jpg',
  ...
  // },
  // {
  //   'id': '6867427b-6070-4954-a29e-8b9111a0d00e',
  //   'title': 'Canal View Prinsengracht',
  //   'type': 'house',
  //   'price': 278,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/7.jpg',
  ...
  // },
  // {
  //   'id': '57a3b244-7c1d-41c1-b5cf-9288235b7187',
  //   'title': 'Perfectly located Castro',
  //   'type': 'room',
  //   'price': 199,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/11.jpg',
  ...
  // },
  // {
  //   'id': '75828b53-f137-4bee-8b90-0994c7be289e',
  //   'title': 'Beautiful & luxurious apartment at great location',
  //   'type': 'hotel',
  //   'price': 188,
  //   'previewImage': 'https://13.design.pages.academy/static/hotel/5.jpg',
